...
- Plugin manager
  ...
  - [`vim.pack`](https://neovim.io/doc/user/pack.html): WORK IN PROGRESS built-in plugin manager!
...
- [nvimdev/modeline.nvim](https://github.com/nvimdev/modeline.nvim): neovim statusline plugin blazing fast than any statusline plugin
...
- [tpope/vim-fugitive](https://github.com/tpope/vim-fugitive): fugitive.vim: A Git wrapper so awesome, it should be illegal <https://www.vim.org/scripts/script.php?script_id=2975>
...
- 🌟 [Saghen/blink.cmp](https://github.com/Saghen/blink.cmp): Performant, batteries-included completion plugin for Neovim <https://cmp.saghen.dev>
- 🌟 [nvimdev/phoenix.nvim](https://github.com/nvimdev/phoenix.nvim): A blazing-fast asynchronous in-process server providing word and path and snippets completion.
...
- [codeberg:FelipeLema/cmp-async-path](https://codeberg.org/FelipeLema/cmp-async-path.git): : nvim-cmp source for filesystem paths with async processing
...
- [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap): Debug Adapter Protocol client implementation for Neovim <https://codeberg.org/mfussenegger/nvim-dap>
...
- [NvChad/NvChad](https://github.com/NvChad/NvChad): Blazing fast Neovim framework providing solid defaults and a beautiful UI, enhancing your neovim experience. <https://nvchad.com>
...
- [my neovim setup](https://kennethnym.com/blog/my-neovim-setup/): keybinds and plugins i use with my neovim.
...
- [Jonas Hietala: Migrating to rocks.nvim](https://www.jonashietala.se/blog/2024/06/02/migrating_to_rocksnvim/)
  - https://github.com/treeman/dotfiles/tree/rocks2
- [Yet Another Neovim Setup Guide — 2024 Edition](https://vineeth.io/posts/neovim-setup)
- [Neovim config for 2025 - Chris Arderne](https://rdrn.me/neovim-2025/)
